...
## Step 1: Identifizieren von Lücken bezüglich der FAIR-Prinzipien

Eigene, bereits produzierte Materialien überprüfen auf Lücken bezüglich der FAIR-Prinzipien

Mögliches Hilfsmittel: Der Kriterienkatalog für Materialien aus dem Themenbereich Forschugnsdatenmanagement
...
## Step 2: Entscheiden, welche Lücken zu schließen sind
...
Nachdem Lücken identifiziert (wurde) und entschieden wurde, welche Lücken geschlossen werden sollen, geht es an die Umsetzung. 
